...
duration= 200; % number of iterations with each run
%%
%------------- ENDCONFIG -----------------------
[ClusterSizes,Connec_matrix,Opinion_matrix] = extend_model_v2(N,M,k,G,phi,duration,no_of_runs,Fake);
...
legend('G1\_with\_Fake','G2\_with\_Fake','G1\_no\_Fake','G2\_no\_Fake');